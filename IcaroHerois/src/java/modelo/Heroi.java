...
@NamedQueries({
    ...
    @NamedQuery(name = "Heroi.findFilter", query = "SELECT h FROM Heroi h WHERE h.codinome like :filtro" 
                                                                        + "or h.nome like :filtro" 
...
public class Heroi implements Serializable {
    ...
    @Column(name = "habilidadedecombate")
    private Integer habilidadedecombate;
    ...
    public Integer getHabilidadedecombate() {
        return habilidadedecombate;
    }

    public void setHabilidadedecombate(Integer habilidadedecombate) {
