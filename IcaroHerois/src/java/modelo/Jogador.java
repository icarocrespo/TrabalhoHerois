...
@NamedQueries({
    ...
    @NamedQuery(name = "Jogador.findFilter", query = "SELECT j FROM Jogador j WHERE j.login like :filtro or j.email like :filtro")
})
public class Jogador implements Serializable {
    ...
    public Jogador(String login, String email, String senha) {
        this.login = login;
        this.email = email;
        this.senha = senha;
    }
